...
class MainHandler(tornado.web.RequestHandler):
    def get(self):
        self.render(
            "index.html",
            page_title = "Jens Books | Home",
            header_text = "Welcome to Jens' Books!",
        )
...
class RecommendedHandler(tornado.web.RequestHandler):
    def get(self):
        self.render(
            "recommended.html",
            page_title = "Jens Books | Recommended Books",
            header_text = "Recommended Readings!",
            books = [
                {
...
class DiscussionHandler(tornado.web.RequestHandler):
    def get(self):
        self.render(
            "discussion.html",
            page_title = "Jens Books | Discussion",
            header_text = "Welcome to Discussion",
            comments = [
                {
                    "user":"Alice",
